...
results <- rffit_LONG(list(SVM_Model=svmfit_RP, GBM_Model=gbmfit_RP, RF_Model=rffit_RP, BestModel = final_fit_RP))
summary(results)
bwplot(results)
...
After research I found that the coordinates from this dataset are in EPSG:3857, WGS 84 / Pseudo-Mercator format. However, using the following library I can find distances in predictions from two different points.
